...
// 宣告 MotorR 為右邊
// 宣告 MotorL 為左邊
#define MotorR_I1     12  //定義 I1 接腳
#define MotorR_I2     10  //定義 I2 接腳
...
// 循線模組
#define L2  A5  // Define Second Right Sensor Pin
#define L1  A4  // Define First Right Sensor Pin
#define M   A3  // Define Middle Sensor Pin
#define R1  A2  // Define First Left Sensor Pin
#define R2  A1  // Define Second Leftt Sensor Pin
